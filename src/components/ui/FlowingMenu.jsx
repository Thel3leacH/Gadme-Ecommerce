...
function MenuItem({ link, text, image }) {
  ...
  const repeatedMarqueeContent = Array.from({ length: 1 }).map((_, idx) => (
    <React.Fragment key={idx}>
      ...
      <div
        className="w-[200px] h-[7vh] my-[2em] mx-[2vw] p-[1em_0] rounded-[10px] bg-cover bg-center"
  ...
  return (
    ...
    >
      ...
      <div
        className="absolute top-0 left-0 w-full h-full overflow-hidden pointer-events-none bg-teal-500 translate-y-[101%]"
        ref={marqueeRef}
      >
